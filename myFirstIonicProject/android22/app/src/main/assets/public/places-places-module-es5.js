(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["places-places-module"], {
  ...
  function srcAppPlacesPlacesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    const routes = [{
      ...
      path: 'place-add',
      loadChildren: () => __webpack_require__.e(
      /*! import() | place-add-place-add-module */
      "common").then(__webpack_require__.bind(null,
      /*! ./place-add/place-add.module */
  ...
  function srcAppPlacesPlacesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_places_service__WEBPACK_IMPORTED_MODULE_2__["PlacesService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])], PlacesPage);
    /***/
  }
}]);
