...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: "",
                loadChildren: () => Promise.all(/*! import() | places-places-module */[__webpack_require__.e("common"), __webpack_require__.e("places-places-module")]).then(__webpack_require__.bind(null, /*! ./places/places.module */ "./src/app/places/places.module.ts")).then(m => m.PlacesPageModule)
            },
            {
                path: ":placeId",
                loadChildren: () => __webpack_require__.e(/*! import() | places-place-detail-place-detail-module */ "common").then(__webpack_require__.bind(null, /*! ./places/place-detail/place-detail.module */ "./src/app/places/place-detail/place-detail.module.ts")).then(m => m.PlaceDetailPageModule)
            }
        ]
    },
    {
        path: "new-place",
        loadChildren: () => __webpack_require__.e(/*! import() | places-place-add-place-add-module */ "common").then(__webpack_require__.bind(null, /*! ./places/place-add/place-add.module */ "./src/app/places/place-add/place-add.module.ts")).then(m => m.PlaceAddPageModule)
    }
];
...
module.exports = __webpack_require__(/*! D:\Cursos\Ionic-Apps\myFirstIonicProject\src\main.ts */"./src/main.ts");
